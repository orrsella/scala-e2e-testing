...
object Dependencies {
  ...
  private val groovy        = "org.codehaus.groovy"     %  "groovy-all"         % "2.3.2"
  private val luceneExpr    = "org.apache.lucene"       %  "lucene-expressions" % "4.9.1"
  ...
  val testkit = deps(finatraDep, specs2, mockito, json4s,  elasticsearch, commonsIo, groovy, luceneExpr)
